...
3. **Diigo** - Bookmark, highlight, and sticky notes on any web page. And access those pages annotated next time anywhere on any browser. 
...
3.  **Proxychains -** work behind proxy easily
...
10. **Tor Browser -** Anonymous web browsing, bypass proxy.

11. **Sublime, Atom, VS Code editor**
...
23. **MegaSync** - Mega client to sync files with MEGA cloud storage
